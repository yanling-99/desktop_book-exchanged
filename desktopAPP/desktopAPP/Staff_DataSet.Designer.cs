...
namespace desktopAPP {
    ...
    public partial class Staff_DataSet : global::System.Data.DataSet {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public staffRow AddstaffRow(string uid, string name, string email) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public staffRow FindByuid(string uid) {
            ...
            public string name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'staff\' 中資料行 \'name\' 的值是 DBNull。", e);
                    }
                }
                set {
...
namespace desktopAPP.Staff_DataSetTableAdapters {
    ...
    public partial class staffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[staff] WHERE (([uid] = @Original_uid) AND ((@IsNull_name = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[staff] ([uid], [name], [email]) VALUES (@uid, @name, @email);\r" +
                "\nSELECT uid, name, email FROM staff WHERE (uid = @uid)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[staff] SET [uid] = @uid, [name] = @name, [email] = @email WHERE (([" +
                "uid] = @Original_uid) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @O" +
                "riginal_name)));\r\nSELECT uid, name, email FROM staff WHERE (uid = @uid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT uid, name, email FROM dbo.staff";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[staff] ([uid], [name], [email]) VALUES (@uid, @name, @email);";
        ...
        public virtual int Delete(string Original_uid, string Original_name) {
        ...
        public virtual int Insert(string uid, string name, string email) {
            if ((uid == null)) {
        ...
        public virtual int Update(string uid, string name, string email, string Original_uid, string Original_name) {
            if ((uid == null)) {
                throw new global::System.ArgumentNullException("uid");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string email, string Original_uid, string Original_name) {
            return this.Update(Original_uid, name, email, Original_uid, Original_name);
        }
        ...
        public virtual int InsertQuery(string uid, string name, string email) {
